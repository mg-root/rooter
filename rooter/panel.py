...
class Panel:
    def __init__(self, title=None, title_color='', text="Panel", color='', border_color=''):
        self.__title = title
        self.__title_color = title_color if title_color != '' else color
        self.__text = text
        self.__color = color
        self.__border_color = border_color if border_color != '' else color
